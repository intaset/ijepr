...
<script>
  (function() {
    var cx = '016656741306535874023:77ruzq3fc-q';
...
<div class="j-header">
  <div class="name">
    <h1>International Journal of Environmental Pollution and Remediation (IJEPR)<br><p class="body">ISSN: 1929-2732</p></h1>
    <div class="oalink">
    ...
    <img src="../img/journals/j-ijepr.jpg" class="j-img">
</div>
</div>

<div class="desktop jhead">
  <div class="name">
    <h1>International Journal of Environmental Pollution and Remediation (IJEPR)</h1>
    <div class="issn">
...
$confirmed = 0;
 ...
 // now we insert it into the database
  ...
  $subject = "International Journal of Environmental Pollution and Remediation (IJEPR)"; 
  $message = "Thank you for signing up to receive alerts for IJEPR - International Journal of Environmental Pollution and Remediation.
